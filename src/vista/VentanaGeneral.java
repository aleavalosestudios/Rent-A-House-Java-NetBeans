...
public class VentanaGeneral extends javax.swing.JFrame {
    ...
    public VentanaGeneral() {
        ...
        setTitle("RENT A HOUSE");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setSize(800,600);
        setLocationRelativeTo(null);
        
        //Crear el Jpanel que actuara como area de contenido
        contenidoPanel = new JPanel();
        cardLayout = new CardLayout();
        contenidoPanel.setLayout(cardLayout);
        
        //Vistas
        
        VentanaPrincipal ventanaPrincipal = new VentanaPrincipal();
        
        contenidoPanel.add(ventanaPrincipal,"Ventana Principal");

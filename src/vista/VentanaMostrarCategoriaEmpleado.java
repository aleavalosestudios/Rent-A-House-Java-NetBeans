 ...
 * @author aleja
 */
public class VentanaMostrarCategoriaEmpleado extends javax.swing.JFrame {

    /**
     * Creates new form VentanaMostrarCategoriaEmpleado
     */
    CategoriaEmpleadoDao categoriaEmpleadoDao = new CategoriaEmpleadoDao();
    
    
    public VentanaMostrarCategoriaEmpleado() {
        initComponents();        
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaMostrarCategoriaEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaMostrarCategoriaEmpleado().setVisible(true);
            }
        });
    }
